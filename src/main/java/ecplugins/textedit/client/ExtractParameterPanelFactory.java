...
// ExtractParameterPanelFactory.java --
//
// ExtractParameterPanelFactory.java is part of ElectricCommander.
//
...
public class ExtractParameterPanelFactory
    extends ComponentBaseFactory
{
    ...
    {
            return new ExtractParameterPanel();
    }
}
